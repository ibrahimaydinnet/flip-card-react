...
const Face = (props) => {
    ...
    const style = Object.assign({ top: 0, left: 0, width: "100%", height: "100%", transition: `${speed}s`, WebkitTransition: `${speed}s`, msTransition: `${speed}s`, MozTransition: `${speed}s`, OTransition: `${speed}s`, backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", MozBackfaceVisibility: "hidden", transform: transform(direction)(deg), WebkitTransform: transform(direction)(deg), msTransform: transform(direction)(deg), OTransform: transform(direction)(deg), position }, props.style);
