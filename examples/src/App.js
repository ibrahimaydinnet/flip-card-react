    ...
    return (
        <div className="row">
            <div className="column">
                <h1>flip-card-react examples</h1>
                <div className="row">
                    <div className="column">
                        <div className="card">
                            <FlipCard isFlipped={horizontalFlipped} front={horizontalFront} back={horizontalBack}/>
                        </div>
                    </div>
                    <div className="column">
                        <div className="card">
                            <FlipCard isFlipped={verticalFlipped} front={verticalFront} back={verticalBack} direction="vertical"/>
                        </div>
                    </div>
                    <div className="column">
                        <div className="card">
                            <FlipCard isFlipped={fastFlipped} front={fastFront} back={fastBack} direction="horizontal" speed={0.1}/>
                        </div>
                    </div>
                    <div className="column">
                        <div className="card">
                            <FlipCard isFlipped={slowFlipped} front={slowFront} back={slowBack} direction="horizontal" speed={2}/>
                        </div>
                    </div>
                </div>
            </div>
